...
Hi there👋! This is JC, a Tenure-Track Assistant Professor with Department of Computing ([COMP](https://www.polyu.edu.hk/comp/people/academic-staff/prof-guo-jingcai/)) at [The Hong Kong Polytechnic University (PolyU)](https://www.polyu.edu.hk/en/), leading the [***<font color="Crimson">Lumen Lab</font>***](https://lumen-lab-polyu.github.io/). I also hold a joint appointment in Department of Land Surveying and Geospatial Science ([LSGS](https://www.polyu.edu.hk/lsgs/people/academic-staff/prof-jingcai-guo/)). I defended my Ph.D. in December 2020 at the same university and was fortunate to be supported by the [Hong Kong PhD Fellowship](https://cerg1.ugc.edu.hk/hkpfs/index.html) (**HKPFS**) from **Hong Kong RGC** during this period. From 2021 to 2022, I did postdoctoral training at [The University of Sydney](https://www.sydney.edu.au/), Australia, where I was also a Visiting Ph.D. from 2019 to 2020. Prior to that, I received my M.Phil. from [Waseda University](https://www.waseda.jp/top/), Japan, and B.Eng. from [Sichuan University](https://en.scu.edu.cn/), China, all in Computer Science and AI/ML. Even earlier, before starting my Ph.D., I was in investment banking for nearly two years after Waseda.

I am generally interested in *<font color="Crimson">AI Efficiency</font>* and *<font color="Crimson">Edge-Native</font>* *<font color="Crimson">AI</font>*, targeting learning, deployment, inference, and adaptation with *<font color="Crimson">Constrained Resources</font>* in terms of *<font color="Crimson">Data</font>*, *<font color="Crimson">Computing Capability</font>*, as well as exploring derivative *<font color="Crimson">Applications</font>* across a wide spectrum, in particular at *<font color="Crimson">the Edges</font>*. Ultimately, achieving *<font color="Crimson">Self-Evolving AI Systems</font>* in *<font color="Crimson">Real Physical Environments</font>*. As the **Principal Investigator (PI)**, our research has been funded by multiple external research grants, including **General Research Funds (GRF)** and **Early Career Scheme (ECS)** from the **Research Grants Council of Hong Kong (RGC)**, **Young Scientists Fund** from the **National Natural Science Foundation of China (NSFC)**, and **Donations** from **Industrial Companies**, etc. I have served as organizing/technical **Chair Members** for multiple leading CS conference, like SRDS 2022 (Austria), VTC 2024 Fall (USA), ACM-MM 2025 (Ireland), MSN 2026 (China), etc. I have regularly served as **Area Chair** and/or **Senior PC** for prestigious venues like ICML, ICLR, AAAI, IJCAI, ACM-MM, NeurIPS, etc. I am currently serving as **Executive Editor-in-Chief** for [*Edge Intelligence and Systems*](https://www.sciltp.com/journals/eis/editorial-board), serving as **Action Editor** for [*Transactions on Machine Learning Research (TMLR)*](https://jmlr.org/tmlr/index.html), serving as **Associate Editor** for [*Pattern Recognition*](https://www.sciencedirect.com/journal/pattern-recognition/about/editorial-board) and [*IEEE Open Journal of the Computer Society (OJ-CS)*](https://www.computer.org/csdl/journal/oj/about/107402?title=Editorial%20Board&periodical=IEEE%20Open%20Journal%20of%20the%20Computer%20Society), and serving as **Guest Editor** for [*IEEE Transactions on Computational Social Systems (TCSS)*](https://ieeexplore.ieee.org/xpl/RecentIssue.jsp?punumber=6570650) and [*Complex & Intelligent Systems*](https://link.springer.com/journal/40747). I am a panel/external reviewer for NSFC and RSKTO (UM). I am a Senior Member of IEEE.

<span class='anchor' id='lumen-group'></span>
# 🌏 Lumen Group 
...
***<font color="Crimson">Opening</font>***: we are always looking for self-motivated **PhD Students**, **Postdoctoral Researchers**, and **Research Assistants** to work and have fun together on multiple research projects. Drop me an email (<jc-jingcai.guo@polyu.edu.hk>) with your complete CV & supporting documents if you are interested. Candidates with strong programming and mathematics backgrounds are preferred. **Visiting Students/Researchers** (remote/onsite) are also welcome!<br>
*<font color="Crimson">Due to the high volume of inquiries, we apologize that we cannot reply to every inquiry email that was not potentially matched.</font>*
...
- **<font color="Crimson">[PI]:</font>** **Start-Up Fund**<br>
...
![Static Badge](https://img.shields.io/badge/Data-8A2BE2) **-** **Learning from Limited** **<font color="Crimson">Data</font>**

![Static Badge](https://img.shields.io/badge/Capability-00FF7F) **-** **Learning with Limited Computing** **<font color="Crimson">Capability</font>**
...
*IEEE/CVF Conference on Computer Vision and Pattern Recognition* (**<font color="Crimson">CVPR Findings</font>**), 2026.<br>
...
*ACM International Conference on Multimedia* (**<font color="Crimson">ACM-MM</font>**), 2026.
...
- ![Static Badge](https://img.shields.io/badge/APPs-DAA520) **-** Information Entropy for LLM-Generated Text Detection,<br>
X. Yi, H. Wang, **<font size=4>J. Guo<sup>#</sup></font>**,<br>
*International Joint Conference on Artificial Intelligence* (**<font color="Crimson">IJCAI</font>**), 2026.

- ![Static Badge](https://img.shields.io/badge/Data-8A2BE2) **-** PMCE: Probabilistic Multi-Granularity Semantics with Caption-Guided Enhancement for Few-Shot Learning,<br>
J. Wu, C. Gao, J. Hu, H. Li, X. Cao, **<font size=4>J. Guo<sup>#</sup></font>**,<br>
*International Joint Conference on Artificial Intelligence* (**<font color="Crimson">IJCAI</font>**), 2026.

- ![Static Badge](https://img.shields.io/badge/Capability-00FF7F) **-** Gradient Enhancement Task Aware Post-training Quantization,<br>
Y. Shao, Y. Gu, M. Yan, S. Chen, H. Liu, Z. Yan, Y. Li, Y. Wang, Q. Song, H. Tang, H. Qin, **<font size=4>J. Guo<sup>#</sup></font>**, N. Sebe,<br>
*International Joint Conference on Artificial Intelligence* (**<font color="Crimson">IJCAI</font>**), 2026.
...
*International Conference on Machine Learning* (**<font color="Crimson">ICML</font>**), 2026.
...
*Design Automation Conference* (**<font color="Crimson">DAC</font>**), 2026.
...
- ![Static Badge](https://img.shields.io/badge/Data-8A2BE2) **-** Balancing Cross-Modal Attention for Generalized Zero-Shot Learning,<br>
  ...
  *ACM International Conference on Multimedia* (**<font color="Crimson">ACM-MM</font>**), 2025.
...
- ![Static Badge](https://img.shields.io/badge/APPs-DAA520) **-** GraphCL: Graph-based Clustering for Semi-Supervised Medical Image Segmentation,<br>
  ...
  *International Conference on Machine Learning* (**<font color="Crimson">ICML</font>**), 2025.
...
- ![Static Badge](https://img.shields.io/badge/Data-8A2BE2) **-** SVIP: Semantically Contextualized Visual Patches for Zero-Shot Learning,<br>
  ...
  *IEEE/CVF International Conference on Computer Vision* (**<font color="Crimson">ICCV</font>**), 2025.
...
- ![Static Badge](https://img.shields.io/badge/Data-8A2BE2) **-** TsCA: On the Semantic Consistency Alignment via Conditional Transport for Compositional Zero-Shot Learning,<br>
  ...
  *International Joint Conference on Artificial Intelligence* (**<font color="Crimson">IJCAI</font>**), 2025.
...
- ![Static Badge](https://img.shields.io/badge/Data-8A2BE2) **-** Neuron: Learning Context-Aware Evolving Representations for Zero-Shot Skeleton Action Recognition,<br>
  ...
  *IEEE/CVF Conference on Computer Vision and Pattern Recognition* (**<font color="Crimson">CVPR</font>**), 2025.
...
- ![Static Badge](https://img.shields.io/badge/Data-8A2BE2) **-** Epsilon: Exploring Comprehensive Visual-Semantic Projection for Multi-Label Zero-Shot Learning,<br>
  ...
  *AAAI Conference on Artificial Intelligence* (**<font color="Crimson">AAAI</font>**), 2025.
...
- ![Static Badge](https://img.shields.io/badge/APPs-DAA520) **-** SRCD: Semantic Reasoning with Compound Domains for Single-Domain Generalized Object Detection,<br>
  ...
  *IEEE Transactions on Neural Networks and Learning Systems* (**<font color="Crimson">TNNLS</font>**), 2025.
...
- ![Static Badge](https://img.shields.io/badge/APPs-DAA520) **-** A Paradigm of Temporal-Weather-Aware Transition Pattern for POI Recommendation,<br>
  ...
  *CAAI Transactions on Intelligence Technology* (**<font color="Crimson">TIT</font>**), 2025.
...
- ![Static Badge](https://img.shields.io/badge/Data-8A2BE2) **-** A Multi-Modal Adversarial Method for Personalized Recommendation under Uncertain Missing Modalities,<br>
  ...
  *IEEE Transactions on Services Computing* (**<font color="Crimson">TSC</font>**), 2025.
...
- ![Static Badge](https://img.shields.io/badge/Data-8A2BE2) **-** ParsNets: A Parsimonious Composition of Orthogonal and Low-Rank Linear Networks for Zero-Shot Learning,<br>
  ...
  *International Joint Conference on Artificial Intelligence* (**<font color="Crimson">IJCAI</font>**), 2024; <font color="Crimson">long oral</font>, acceptance rate ~= 2.3%.
...
- ![Static Badge](https://img.shields.io/badge/Data-8A2BE2) **-** Fine-Grained Side Information Guided Dual-Prompts for Zero-Shot Skeleton Action Recognition,<br>
  ...
  *ACM International Conference on Multimedia* (**<font color="Crimson">ACM-MM</font>**), 2024.
...
- ![Static Badge](https://img.shields.io/badge/Capability-00FF7F) **-** Causally Motivated Personalized Federated Invariant Learning with Shortcut-Averse Information-Theoretic Regularization,<br>
  ...
  *International Conference on Machine Learning* (**<font color="Crimson">ICML</font>**), 2024.
...
Y. Sun, X. Cao, Y. Wang, W. Ye, **<font size=4>J. Guo</font>**, Q. Guo,<br>
  *Annual Conference on Neural Information Processing Systems* (**<font color="Crimson">NeurIPS</font>**), 2024.
...
- ![Static Badge](https://img.shields.io/badge/APPs-DAA520) **-** CGraphNet: Contrastive Graph Context Prediction for Sparse Unlabeled Short Text Representation Learning on Social Media,<br>
  ...
  *IEEE Transactions on Computational Social Systems* (**<font color="Crimson">TCSS</font>**), 2024.
...
*IEEE Transactions on Multimedia* (**<font color="Crimson">TMM</font>**), 2024.
...
*IEEE Transactions on Mobile Computing* (**<font color="Crimson">TMC</font>**), 2024.
...
- ![Static Badge](https://img.shields.io/badge/Capability-00FF7F) **-** Personalized Federated Domain-Incremental Learning Based on Adaptive Knowledge Matching,<br>
  ...
  *European Conference on Computer Vision* (**<font color="Crimson">ECCV</font>**), 2024.
...
- ![Static Badge](https://img.shields.io/badge/APPs-DAA520) **-** Multi-modal Dual-embedding Networks for Malware Open-set Recognition,<br>
  ...
  *IEEE Transactions on Neural Networks and Learning Systems* (**<font color="Crimson">TNNLS</font>**), 2024.
...
- ![Static Badge](https://img.shields.io/badge/APPs-DAA520) **-** Unveiling User Interests: A Deep User Interest Exploration Network for Sequential Location Recommendation,<br>
  ...
  *Information Sciences* (**<font color="Crimson">INS</font>**), 2024.
...
- ![Static Badge](https://img.shields.io/badge/Data-8A2BE2) **-** On the Robustness of Neural-enhanced Video Streaming Against Adversarial Attacks,<br>
  ...
  *AAAI Conference on Artificial Intelligence* (**<font color="Crimson">AAAI</font>**), 2024.
...
- ![Static Badge](https://img.shields.io/badge/Capability-00FF7F) **-** PASS: Patch Automatic Skip Scheme for Efficient On-device Video Perception,<br>
  ...
  *IEEE Transactions on Pattern Analysis and Machine Intelligence* (**<font color="Crimson">TPAMI</font>**), 2024.
...
- ![Static Badge](https://img.shields.io/badge/Capability-00FF7F) **-** Learning Personalized Causally Invariant Representations for Heterogeneous Federated Clients,<br>
  ...
  *International Conference on Learning Representations* (**<font color="Crimson">ICLR</font>**), 2024.
...
- ![Static Badge](https://img.shields.io/badge/Capability-00FF7F) **-** DiPrompT: Disentangled Prompt Tuning for Multiple Latent Domain Generalization in Federated Learning,<br>
  ...
  *IEEE/CVF Conference on Computer Vision and Pattern Recognition* (**<font color="Crimson">CVPR</font>**), 2024.
...
- ![Static Badge](https://img.shields.io/badge/Data-8A2BE2) **-** Graph Knows Unknowns: Reformulate Zero-Shot Learning as Sample-Level Graph Recognition,<br>
  **<font size=4>J. Guo</font>**, S. Guo, Q. Zhou, Z. Liu, X. Lu, F. Huo,<br>
  *AAAI Conference on Artificial Intelligence* (**<font color="Crimson">AAAI</font>**), 2023.
...
- ![Static Badge](https://img.shields.io/badge/Data-8A2BE2) **-** Decomposed Soft Prompt Guided Fusion Enhancing for Compositional Zero-Shot Learning,<br>
  ...
  *IEEE/CVF Conference on Computer Vision and Pattern Recognition* (**<font color="Crimson">CVPR</font>**), 2023.
...
- ![Static Badge](https://img.shields.io/badge/Capability-00FF7F) **-** Towards Data-Independent Knowledge Transfer in Model-Heterogeneous Federated Learning,<br>
  ...
  *IEEE Transactions on Computers* (**<font color="Crimson">TC</font>**), 2023.
...
- ![Static Badge](https://img.shields.io/badge/APPs-DAA520) **-** UTDNet: A Unified Triplet Decoder Network for Multimodal Salient Object Detection,<br>
  ...
  *Neural Networks* (**<font color="Crimson">NN</font>**), 2023.
...
- ![Static Badge](https://img.shields.io/badge/Capability-00FF7F) **-** Hwamei: A Learning-Based Synchronization Scheme for Hierarchical Federated Learning,<br>
  ...
  *IEEE International Conference on Distributed Computing Systems* (**<font color="Crimson">ICDCS</font>**), 2023.
...
- ![Static Badge](https://img.shields.io/badge/Capability-00FF7F) **-** Towards Fairer and More Efficient Federated Learning via Multidimensional Personalized Edge Models,<br>
  ...
  *International Joint Conference on Neural Networks* (**<font color="Crimson">IJCNN</font>**), 2023.
...
- ![Static Badge](https://img.shields.io/badge/Capability-00FF7F) **-** Personalized Federated Learning with Contextualized Generalization,<br>
  ...
  *International Joint Conference on Artificial Intelligence* (**<font color="Crimson">IJCAI</font>**), 2022.
...
- ![Static Badge](https://img.shields.io/badge/Data-8A2BE2) **-** Towards Unbiased Multi-Label Zero-Shot Learning with Pyramid and Semantic Attention,<br>
  ...
  *IEEE Transactions on Multimedia* (**<font color="Crimson">TMM</font>**), 2022.
...
- ![Static Badge](https://img.shields.io/badge/APPs-DAA520) **-** Conservative Novelty Synthesizing Network for Malware Recognition in an Open-Set Scenario,<br>
  ...
  *IEEE Transactions on Neural Networks and Learning Systems* (**<font color="Crimson">TNNLS</font>**), 2021.<br>
  (<font color="Crimson">Outstanding Paper Award of</font> [<font color="Crimson">GDCA</font>](http://www.gdcomf.com/))
...
- ![Static Badge](https://img.shields.io/badge/Capability-00FF7F) **-** INT8 Training with Loss-Aware Compensation and Backward Quantization for Tiny On-Device Learning,<br>
  ...
  *USENIX Annual Technical Conference* (**<font color="Crimson">USENIX-ATC</font>**), 2021.
...
- ![Static Badge](https://img.shields.io/badge/Capability-00FF7F) **-** On-Device Learning Systems for Edge Intelligence: A Software and Hardware Synergy Perspective,<br>
  ...
  *IEEE Internet of Things Journal* (**<font color="Crimson">IoT-J</font>**), 2021.

- ![Static Badge](https://img.shields.io/badge/APPs-DAA520) **-** Dual-View Attention Networks for Single Image Super-Resolution,<br>
  **<font size=4>J. Guo</font>**, S. Ma, J. Zhang, Q. Zhou, S. Guo,<br>
  *ACM International Conference on Multimedia* (**<font color="Crimson">ACM-MM</font>**), 2020.
...
- ![Static Badge](https://img.shields.io/badge/Data-8A2BE2) **-** A Novel Perspective to Zero-Shot Learning: Towards an Alignment of Manifold Structures via Semantic Feature Expansion,<br>
  ...
  *IEEE Transactions on Multimedia* (**<font color="Crimson">TMM</font>**), 2020.
...
- ![Static Badge](https://img.shields.io/badge/Data-8A2BE2) **-** Adaptive Adjustment with Semantic Feature Space for Zero-Shot Recognition,<br>
  **<font size=4>J. Guo</font>**, S. Guo,<br>
  *IEEE International Conference on Acoustics, Speech, and Signal Processing* (**<font color="Crimson">ICASSP</font>**), 2019.
...
- ![Static Badge](https://img.shields.io/badge/Data-8A2BE2) **-** AMS-SFE: Towards an Alignment of Manifold Structures via Semantic Feature Expansion for Zero-Shot Learning,<br>
  **<font size=4>J. Guo</font>**, S. Guo,<br>
  *IEEE International Conference on Multimedia and Expo* (**<font color="Crimson">ICME</font>**), 2019.
...
- ![Static Badge](https://img.shields.io/badge/Data-8A2BE2) **-** An improved incremental training approach for large-scaled dataset based on support vector machine,<br>
  ...
  *IEEE/ACM International Conference on Big Data Computing, Applications and Technologies* (**<font color="Crimson">BDCAT</font>**), 2016.
...
- Internet Infrastructure and Protocols ([Syllabus](https://www.polyu.edu.hk/comp/docdrive/tpg/subject/COMP5311.pdf)), 2024.
- Data Structures and Database Systems ([Syllabus](https://www.polyu.edu.hk/comp/docdrive/tpg/subject/COMP5112.pdf)), 2023.
...
- **Tutorial Chair:** The 22nd International Conference on Mobility, Sensing and Networking (**MSN** 2026)
...
- **Executive Editor-in-Chief:** Edge Intelligence and Systems (**EIS**, 2026-)
- **Action Editor:** Transactions on Machine Learning Research (**TMLR**, 2026-)
- **Associate Editor:** Pattern Recognition (**PR**, 2025-)
- **Guest Editor:** Complex & Intelligent Systems (**CAIS**, 2025-)
...
- Reviewer for IEEE Transactions on Computational Social Systems (**IEEE TCSS**)
...
<img src="./images/nvidia.png" width = "115" />
<img src="./images/tinghsing.jpeg" width = "115" />
<img src="./images/huawei.png" width = "107" />
