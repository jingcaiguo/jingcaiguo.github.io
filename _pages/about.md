...
I am generally interested in ***<font color="Crimson">AI Efficiency</font>*** and ***<font color="Crimson">Edge-Native</font>*** ***<font color="Crimson">AI</font>***, targets learning/modeling with ***<font color="Crimson">Constrained Resources</font>*** in terms of ***<font color="Crimson">Data</font>***, ***<font color="Crimson">Computing Capability</font>***, as well as exploring derivative ***<font color="Crimson">Applications</font>*** across a wide spectrum, in particular ***<font color="Crimson">At the Edges</font>***. Some specific topics include **zero/few-shot learning**, **model adaptation and compression**, **collaborative/federated learning**, **representation learning**, and **lightweight solutions** for **large foundation models** and **world models**. Our works are published in various prestigious venues, including AAAI, IJCAI, CVPR, ICML, ICLR, NeurIPS, MM, ATC, ICDCS, TNNLS, TPAMI, TMM, TC, TCSS, etc. As the **Principal Investigator (PI)**, our research has been funded by multiple external research grants, including **General Research Funds (GRF)** and **Early Career Scheme (ECS)** from the **Research Grants Council of Hong Kong (RGC)**, **Young Scientists Fund** from the **National Natural Science Foundation of China (NSFC)**, and **donation/cooperative project** from **Industrial Companies**, etc. 
